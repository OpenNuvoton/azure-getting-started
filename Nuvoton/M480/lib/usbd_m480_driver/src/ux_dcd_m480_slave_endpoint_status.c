...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _ux_dcd_m480_slave_endpoint_status                   PORTABLE C      */
/*                                                           6.0          */
/*  AUTHOR                                                                */
/*                                                                        */
...
UINT  _ux_dcd_m480_slave_endpoint_status(UX_DCD_M480_SLAVE *dcd_m480_slave, ULONG endpoint_index)
{
    ...
    ed =  &dcd_m480_slave -> ux_dcd_m480_slave_ed[endpoint_index];
    ...
    if ((ed -> ux_m480_slave_ed_status & UX_DCD_M480_SLAVE_ED_STATUS_STALLED) == 0)
        return(UX_FALSE);
    else            
        return(UX_TRUE);
}
